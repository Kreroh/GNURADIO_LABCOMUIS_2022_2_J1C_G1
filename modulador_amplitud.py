...
# Author: Jose_Yanez_Weimar_Vega_J1C_G1
...
class modulador_amplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "modulador_amplitud")
        ...
        self._GTX_win = RangeWidget(self._GTX_range, self.set_GTX, "Gnancia transmisor", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=modulador_amplitud, options=None):
